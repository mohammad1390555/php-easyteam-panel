...
<head>
    ...
    <!-- Vazir Font (Local) -->
    <style>
        // // // // // // // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionfont-face {
            font-family: 'Vazir';
...
<body data-page="<?= htmlspecialchars($page ?? 'login') ?>" data-lang="<?= Language::getCurrentLanguage() ?>">
    <!-- SVG Sprite -->
    <?php $sprite = // // // // // // // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionfile_get_contents(__DIR__ . '/../assets/icons/sprite.svg'); ?>
    <?php if ($sprite): ?>
        <?= $sprite ?>
    <?php else: ?>
