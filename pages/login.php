...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $verifyResult = // // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionfile_get_contents($verifyUrl, false, $context);
