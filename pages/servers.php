    ...
    <div class="card form-card">
        ...
        <form method="post" class="form">
            ...
            <div class="form-actions">
                ...
                <button type="submit" class="btn btn-primary"><svg class="icon"><use href="assets/icons/sprite.svg#icon-rocket"/></svg> <?= __('servers_create') ?></button>
            </div>
        </form>
    </div>
    <?php endif; ?>
