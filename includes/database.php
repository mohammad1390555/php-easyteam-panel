...
class Database {
    ...
    public static function createTables(): void {
        ...
        // Performance indexes (idempotent - use IF NOT EXISTS)
        $indexes = [
            "CREATE INDEX IF NOT EXISTS idx_servers_user_id ON servers(user_id)",
            "CREATE INDEX IF NOT EXISTS idx_servers_status ON servers(status)",
            "CREATE INDEX IF NOT EXISTS idx_servers_user_status ON servers(user_id, status)",
            "CREATE INDEX IF NOT EXISTS idx_versions_version ON server_versions(version)",
            "CREATE INDEX IF NOT EXISTS idx_versions_installed ON server_versions(installed)",
