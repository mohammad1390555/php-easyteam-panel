...
function checkRequirements(): array {
    ...
    // Storage Writable
    $storageWritable = is_writable(__DIR__ . '/storage') || // // // // // // // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionmkdir(__DIR__ . '/storage', 0755, true);
    $requirements[] = [
        'key' => 'writable',
...
<head>
    ...
    <link href="https://cdn.jsdelivr.net/gh/rastikerdar/vazir-font// // // // // // // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionv30.1.0/dist/font-face.css" rel="stylesheet" type="text/css">
    <style>
        ...
        <div class="card">
            ...
            <?php elseif ($step == 3): ?>
                ...
                <form method="post">
                    ...
                    <div class="form-group">
                        <label>ایمیل</label>
                        <input type="email" name="email" required placeholder="admin// // // // // // // // // // // // @error suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionerror suppressionexample.com">
                    </div>
                    <div class="form-group">
